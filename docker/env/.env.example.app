...
## Pour utiliser Groq (Rapide et Gratuit) :#   1. Mettre GENERATION_BACKEND=groq#   2. Obtenir une clé API sur https://console.groq.com/keys#   3. Mettre votre clé dans GROQ_API_KEY#   4. Choisir un modèle : GENERATION_MODEL_ID=llama-3.3-70b-versatile#   Modèles disponibles : llama-3.3-70b-versatile, llama-3.1-8b-instant, mixtral-8x7b-32768
